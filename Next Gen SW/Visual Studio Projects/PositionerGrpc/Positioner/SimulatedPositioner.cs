...
namespace Positioner
{
    ...
    /// <summary>
    /// Implementation of the ETS Positioner
    /// </summary>
    public class SimulatedPositioner : Axis
    {
        ...
        {
            PosConnection = new SimulatedConnection();
        }
        ...
        private double[] _speedSettingsDegreesPerSec = new double[8] { 5.0F, 10.0F, 15.0F, 20.0F, 25.0F, 30.0F, 35.0F, 40.0F };
